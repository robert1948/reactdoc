"""
Django settings for reactdoc project.
...
# Add the folder where the React build will be copied:
TEMPLATES[0]['DIRS'] = [os.path.join(BASE_DIR, 'build')]

# (Optional) If you need to serve extra static assets from the React build:
STATICFILES_DIRS = [
